                ...
                .globalConfig(builder -> {
                    builder.author("kkoneone11") // 设置作者
                           // .enableSwagger() // 开启 swagger 模式
                            ...
                            .outputDir("D:/cloud/cloud-photo-3121004041/cloud-photo-users" + "/src/main/java"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.cloud.photo") // 设置父包名
                          ...
                          //  .other("model.dto") // 设置dto包名
                            .pathInfo(Collections.singletonMap(OutputFile.xml, "D:/cloud/cloud-photo-3121004041/cloud-photo-users"
                                    + "/src/main/java/com/cloud/photo/users/mapper")); // 设置mapperXml生成路径
                })
